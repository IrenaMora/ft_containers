...
int	main(void)
{
	...
	int	position = 1;
	std::vector<std::string>	my_vector1;
	...
	std::vector<std::string>::iterator	first = my_vector1.begin();
	std::vector<std::string>::iterator	last = my_vector1.end();
	while (first != last)
	{
	...
	position = 1;
	std::vector<std::string>::const_iterator	cfirst = my_vector1.cbegin();
	std::vector<std::string>::const_iterator	clast = my_vector1.cend();
	while (cfirst != clast)
	{
	...
	position = 1;
	std::vector<std::string>::reverse_iterator	rfirst = my_vector1.rbegin();
	std::vector<std::string>::reverse_iterator	rlast = my_vector1.rend();
	while (rfirst != rlast)
	{
	...
	std::vector<std::string>	my_vector2(my_vector1);
	position = 1;
	...
	std::vector<std::string>	my_vector3(my_vector1);
	position = 1;
	...
	std::stack<int>	my_stack2(my_stack1);
	std::cout << "\tCopy OK " << std::endl;
	std::stack<int>	my_stack3 = my_stack1;
	...
	std::map<int, std::string>	my_map1;
	my_map1.insert(std::make_pair(1, "My string 1"));
	my_map1.insert(std::make_pair(2, "My string 2"));
	my_map1.insert(std::make_pair(3, "My string 3"));
	std::cout	<< std::endl
				 << "Map: " << std::endl
	...
	std::map<int, std::string>	my_map2(my_map1);
	std::map<int, std::string>	my_map3 = my_map1;
	std::cout	<< std::endl
				 << "Copy and assignment constructors using iterators: " << std::endl;
	std::map<int, std::string>::iterator iter_first1 = my_map1.begin();
	std::map<int, std::string>::iterator iter_last1 = my_map1.end();
	...
	std::map<int, std::string>::iterator iter_first2 = my_map2.begin();
	std::map<int, std::string>::iterator iter_last2 = my_map2.end();
	...
	std::map<int, std::string>::const_iterator const_iter_first1 = my_map3.cbegin();
	std::map<int, std::string>::const_iterator const_iter_last1 = my_map3.cend();
	...
	std::map<int, std::string>::reverse_iterator reverse_iter_first1 = my_map1.rbegin();
	std::map<int, std::string>::reverse_iterator reverse_iter_last1 = my_map1.rend();
	...
	my_map2.clear();
	my_map2.insert(std::make_pair(14, "string 4"));
	my_map2.insert(std::make_pair(16, "string 5"));
	std::cout	<< std::endl
	...
	my_map2.insert(std::make_pair(6, "string"));
	my_map2.insert(std::make_pair(9, "string"));
	std::cout	<< std::endl
